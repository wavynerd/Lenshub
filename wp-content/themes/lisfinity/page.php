...
<?php if ( lisfinity_is_core_active() && get_queried_object_id() === (int) lisfinity_get_page_id( 'page-single-listing' ) ): ?>
	<?php include lisfinity_get_template_part( 'page-single-elementor', 'pages' ); ?>
<?php elseif ( lisfinity_is_core_active() && get_queried_object_id() === lisfinity_get_page_id( 'page-business' ) ): ?>
	<?php include lisfinity_get_template_part( 'page-single-business-elementor', 'pages' ); ?>
<?php elseif ( lisfinity_is_core_active() && get_queried_object_id() === lisfinity_get_page_id( 'page-business-premium' ) ): ?>
	<?php include lisfinity_get_template_part( 'page-single-business-premium-elementor', 'pages' ); ?>
<?php elseif ( lisfinity_is_core_active() && is_account_page() ) : ?>
	<?php the_content(); ?>
<?php else: ?>
