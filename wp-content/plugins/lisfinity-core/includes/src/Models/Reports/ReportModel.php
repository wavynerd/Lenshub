<?php
/**
 * Model for our custom Reports functionality
 *
 * @author pebas
...
class ReportModel {
	...
	public static $type = 'product_report';
	...
	protected function register_post_type() {
		...
		$singular = __( 'Product Report', 'lisfinity-core' );
		$plural   = __( 'Product Reports', 'lisfinity-core' );
