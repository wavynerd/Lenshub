<?php
/**
 * Model for our custom Elementor Elements Global functionality
 *
 * @author pebas
...
class ElementsGlobalModel {

	public static $type = 'lisfinity-elements';
	...
	protected function register_post_type() {
		...
		$singular = esc_html__( 'Global Element', 'lisfinity-core' );
		$plural   = esc_html__( 'Global Elements', 'lisfinity-core' );
