<?php
/**
 * Model for our custom Elementor Elements Footer functionality
 *
 * @author pebas
...
class FooterModel {
	...
	public static $type = 'lisfinity_footer';
	...
	protected function register_post_type() {
		...
		$singular = __( 'Footer', 'lisfinity-core' );
		$plural   = __( 'Footers', 'lisfinity-core' );
