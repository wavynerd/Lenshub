...
class Packages_Widget extends Widget_Base {
	...
	public function get_title() {
		return sprintf( __( '%s Price Packages', 'lisfinity-core' ), '<strong>Lisfinity > </strong>' );
	}
	...
	protected function render() {
		...
		include lisfinity_get_template_part( 'packages', 'shortcodes', $args );
	}
