...
namespace Lisfinity\Shortcodes\Controls\SearchPage;
...
class Group_Control_Filters_Typography extends Group_Control_Base {
	...
	public static function get_type() {
		return 'search-filters-title-typography';
	}
