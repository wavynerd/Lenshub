...
namespace Lisfinity\Shortcodes\Controls\Banner;
...
class Group_Control_Banner_Features_Categories_Typography extends Group_Control_Base {
	...
	public static function get_type() {
		return 'banner-features-categories-typography';
	}
