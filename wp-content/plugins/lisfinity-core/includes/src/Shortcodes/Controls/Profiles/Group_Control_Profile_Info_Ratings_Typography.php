...
namespace Lisfinity\Shortcodes\Controls\Profiles;
...
class Group_Control_Profile_Info_Ratings_Typography extends Group_Control_Base {
	...
	public static function get_type() {
		return 'profilesinfo-ratings-typography';
	}
