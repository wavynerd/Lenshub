...
namespace Lisfinity\Shortcodes\Controls\Search_Keyword;
...
class Group_Control_Search_Keyword_Label_Typography extends Group_Control_Base {
	...
	public static function get_type() {
		return 'search-keyword-label-typography';
	}
