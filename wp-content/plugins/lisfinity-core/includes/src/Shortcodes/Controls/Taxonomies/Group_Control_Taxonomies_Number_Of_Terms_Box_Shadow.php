...
namespace Lisfinity\Shortcodes\Controls\Taxonomies;
 ...
 * @since 1.2.2
 */
class Group_Control_Taxonomies_Number_Of_Terms_Box_Shadow extends Group_Control_Base {
	...
	public static function get_type() {
		return 'taxonomies-number_of_terms-box-shadow';
	}
