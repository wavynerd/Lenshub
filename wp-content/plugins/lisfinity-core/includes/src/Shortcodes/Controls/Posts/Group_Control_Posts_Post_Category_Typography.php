...
namespace Lisfinity\Shortcodes\Controls\Posts;
...
class Group_Control_Posts_Post_Category_Typography extends Group_Control_Base {
	...
	public static function get_type() {
		return 'posts-ost-category-typography';
	}
