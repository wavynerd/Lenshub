...
class Group_Control_Category_Typography extends Group_Control_Base {
	...
	protected function prepare_fields( $fields ) {
		array_walk(
			...
			if ( in_array( $field_name, [ 'category-typography', 'popover_toggle' ] ) ) {
				return;
			}
	...
	protected function get_default_options() {
		return [
			'popover' => [
				'starter_name'  => 'category-typography',
