...
namespace Lisfinity\Shortcodes\Controls\Category;
...
class Group_Control_Category_Title_Typography extends Group_Control_Base {
	...
	public static function get_type() {
		return 'category-title-typography';
	}
	...
	protected function prepare_fields( $fields ) {
		array_walk(
			...
			if ( in_array( $field_name, [ 'category-title-typography', 'popover_toggle' ] ) ) {
				return;
			}
	...
	protected function get_default_options() {
		return [
			'popover' => [
				'starter_name'  => 'category-title-typography',
