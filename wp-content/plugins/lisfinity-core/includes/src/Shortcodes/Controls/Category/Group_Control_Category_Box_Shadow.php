 ...
 * @since 1.2.2
 */
class Group_Control_Category_Box_Shadow extends Group_Control_Base {
	...
	protected function get_default_options() {
		return [
			'popover' => [
				...
				'starter_name'  => 'category-box-shadow-type',
				'starter_value' => 'yes',
				'settings'      => [
					'render_type' => 'ui',
				],
