...
class Group_Control_Single_Product_Specification_Typography extends Group_Control_Base {
	...
	public static function get_type() {
		return 'product-single-specification-typography';
	}
	...
	protected function get_default_options() {
		return [
			'popover' => [
				...
				'starter_title' => _x( 'Title Typography', 'Typography Control', 'lisfinity-core' ),
				'settings'      => [
					'render_type' => 'ui',
				],
			],
