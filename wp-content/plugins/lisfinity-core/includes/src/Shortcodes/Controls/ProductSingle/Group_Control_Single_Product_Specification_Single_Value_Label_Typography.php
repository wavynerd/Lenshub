...
class Group_Control_Single_Product_Specification_Single_Value_Label_Typography extends Group_Control_Base {
	...
	public static function get_type() {
		return 'product-single-specification-single-value-label-typography';
	}
	...
	protected function get_default_options() {
		return [
			'popover' => [
				...
				'starter_title' => _x( 'Label Typography', 'Typography Control', 'lisfinity-core' ),
				'settings'      => [
					'render_type' => 'ui',
				],
			],
