...
class Group_Control_Single_Product_Specification_Multiple_Value_Typography extends Group_Control_Base {
	...
	public static function get_type() {
		return 'product-single-specification-multiple-value-typography';
	}
	...
	protected function get_default_options() {
		return [
			'popover' => [
				...
				'starter_title' => _x( 'Value Typography', 'Typography Control', 'lisfinity-core' ),
				'settings'      => [
					'render_type' => 'ui',
				],
			],
