...
class Group_Control_Single_Product_Specification_Single_Value_Typography extends Group_Control_Base {
	...
	public static function get_type() {
		return 'product-single-specification-single-value-typography';
	}
