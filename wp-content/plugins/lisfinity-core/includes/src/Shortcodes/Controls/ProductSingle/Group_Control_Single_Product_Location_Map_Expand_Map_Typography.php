...
class Group_Control_Single_Product_Location_Map_Expand_Map_Typography extends Group_Control_Base {
	...
	public static function get_type() {
		return 'product-single-location-map-expand-map-typography';
	}
