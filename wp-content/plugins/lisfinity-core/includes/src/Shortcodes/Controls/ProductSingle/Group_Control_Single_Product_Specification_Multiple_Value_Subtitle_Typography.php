...
class Group_Control_Single_Product_Specification_Multiple_Value_Subtitle_Typography extends Group_Control_Base {
	...
	public static function get_type() {
		return 'product-single-specification-multiple-value-subtitle-typography';
	}
	...
	public function init_fields() {
		...
		$fields['color'] = [
			'label'          => _x( 'Color', 'Typography Control', 'lisfinity-core' ),
	...
	protected function get_default_options() {
		return [
			'popover' => [
				...
				'starter_title' => _x( 'Subtitle Typography', 'Typography Control', 'lisfinity-core' ),
				'settings'      => [
					'render_type' => 'ui',
				],
			],
