...
namespace Lisfinity\Shortcodes\Controls\Packages;
 ...
 * @since 1.2.2
 */
class Group_Control_Packages_Recommended_Button_Border extends Group_Control_Base {
	/**
	 * Fields.
	 *
	...
	{
		return 'packages-recommended-button-border';
	}
