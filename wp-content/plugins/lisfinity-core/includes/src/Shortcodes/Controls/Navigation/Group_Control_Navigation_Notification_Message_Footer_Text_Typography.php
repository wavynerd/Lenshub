...
class Group_Control_Navigation_Notification_Message_Footer_Text_Typography extends Group_Control_Base {
	...
	public static function get_type() {
		return 'navigation-notification-message-footer-text-typography';
	}
