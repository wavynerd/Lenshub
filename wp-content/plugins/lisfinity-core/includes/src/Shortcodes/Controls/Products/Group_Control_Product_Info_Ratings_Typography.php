...
namespace Lisfinity\Shortcodes\Controls\Products;
...
class Group_Control_Product_Info_Ratings_Typography extends Group_Control_Base {
	...
	public static function get_type() {
		return 'product-info-ratings-typography';
	}
