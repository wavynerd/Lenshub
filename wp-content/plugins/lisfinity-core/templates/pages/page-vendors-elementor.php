<?php
/**
 * Template Name: Page | Vendors Page Template Elementor
 * Description: Page template that is being used as the template for vendors created with the Elementor
 *
 * @author pebas
...
//]; ?>
<!---->
<?php //$elementor_page_id = lisfinity_get_option( 'page-vendors' );
//?>
<!---->
